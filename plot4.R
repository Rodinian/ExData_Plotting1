...
par(mfrow = c(2, 2))
plot(x = data$Date_Time, y= data$Global_active_power,type = "l",ylab="Global Active Power",xlab="")
plot(x = data$Date_Time, y= data$Voltage ,type = "l",ylab="Voltage",xlab="datetime")
